...
class TitleState extends MusicBeatState
{
	...
	var purpleScreen:FlxSprite;
	var credGroup:FlxGroup;
	var funGroup:FlxGroup;
	...
	function startIntro()
	{
		...
		funGroup = new FlxGroup();
		add(funGroup);
		purpleScreen = new FlxSprite().makeGraphic(FlxG.width, FlxG.height, FlxColor.fromRGB(28, 0, 48));
		funGroup.add(purpleScreen);
		...
		blackScreen = new FlxSprite().makeGraphic(FlxG.width, FlxG.height, FlxColor.fromRGB(28, 0, 48));
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Muffin Engine by'], 15);
				case 3:
					addMoreText('MuffinDev', 15);
				case 4:
					deleteCoolText();
				case 5:
					createCoolText(['Made', 'with'], -40);
				case 7:
					addMoreText('Psych Engine 0.5.1', -40);
				case 8:
					deleteCoolText();
